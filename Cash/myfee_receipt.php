...
<body class="padTop53 " >
    ...
    <div id="wrap">
        ...
        <?php
		 $ayear;
		 $d=$con->query("select  * from daily where exp=''  and reason='fees' GROUP BY staffname order by id DESC") or die(mysqli_error($con));
$i=1;
?>
 <thead>
                                        <tr>
...
<td><?php  echo $bu['id']; ?></td> <td><?php  echo $bu['purpose']; ?></td>                                                        
                                                         ...
                                                         <td><a href="../Cash/fee_print.php?id=<?php  echo $bu['id']; ?>" target="new">  <button type="submit" class="btn btn-success" name="do" class="btn btn-success">Print it</button></a></td>
