     ...
     <h3><?php echo $_GET['bank']; ?>  <a href="print_byd.php?type=<?php  echo $_GET['class'];?>&dept=<?php  echo $_GET['dept'];?>" target="new">   
        <button type="button" class="btn btn-info">Print a Copy </button>   </a> | 
        <!-- <a href="print.php?bank=<?php echo $_GET['bank']; ?>">   
