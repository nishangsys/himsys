...
<table>
<td>Purpose</td>
<td>Registration Package</td><td>Admission Package</td><td>T-Shirt</td><td>Student Union</td></tr>
<?php
$d=$con->query("select  * from daily where id='".$_GET['id']."'") or die(mysqli_error($con));
while($bu=$d->fetch_assoc()){
?>
<tr><td>Amount</td>
<td><?php echo number_format($bu['discount']); ?></td><td><?php echo number_format($bu['adminp']); ?></td><td><?php echo number_format($bu['tshirt']); ?></td><td><?php echo number_format($bu['sunion']); ?></td></tr>
<?php } ?>
</table>
<br />
