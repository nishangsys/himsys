    ...
    echo '<tr bgcolor="White">';
      ...
      <td><?php echo $i++; ?></td>
       ...
       <td><?php echo $bu['departmet']; ?></td>
        ...
        <td>
       <a href=javascript:popcontact('../Acc/fees.php?cust=<?php echo $bu['id']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;"><button type="button" class="btn btn-success btn-sm" >Receive Fees</button>
</a>
