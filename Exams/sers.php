...
$do=$conn->query("SELECT * FROM students where fname='$matric' and year_id='$ayear'  order by roll DESC LIMIT 1 ") or die(mysqli_error($conn));

$d=$conn->query("SELECT * FROM students where fname='$matric' and ayear!='$ayear'  order by roll DESC LIMIT 1 ") or die(mysqli_error($conn));
$i=1;
