...
while($bu=$d->fetch_assoc()){
	echo $fees1=$bu['fees'];
               ...
               <tr><td>Academic Year</td><td><input type="text" name="ayear" readonly="readonly" value="<?php echo $rows['ayear'];; ?>" /></td></tr>
...
levels='$levels',departmet='$class1',sex='$sex',year_id='$ayear',c110='$ids',c101='$year',c102='$year2',cxx7='$city',cxx6='$guide',cxx1='$POB',cxx2='$DOB', ") ;


echo $query55=("insert into historic  set  
matricule='$matric',student_name='$fname',
class='$class1',amountpaid='0',amount_paid='$part',expected_amount='$fee',balance='$fee',ids='16',date=CURDATE() ,year_id='$ayear',photo='$matric' ,time='$levels' " ) ;exit;
