...
input,select{
 ...
 ?>" /></td></tr>
 <tr><td>Semester</td><td><input type="text" name="sem" value="<?php echo $term; ?>"  readonly="readonly"/></td></tr>
 <tr><td>Course Code</td><td><input type="text" name="course" value="<?php echo $course; ?>"  readonly="readonly"/></td></tr>
              ...
              <tr><td>Currant Exams Marks</td><td><input type="text" name="nca"  value="<?php echo $exam; ?>" readonly="readonly"/></td></tr>
		 ...
		 echo $who;		 ?>" required="required"  />
                  ...
                  <tr><td></td><td><button type="submit" name="add" class="btn btn-danger btn-lg" onclick="return confirm('Are you sure you want to delete <?php echo $course; ?> marks')"    >Delete</button></td></tr>
...
$res=$conn->query("DELETE FROM resit where fname='$course' and sex='$term' and matricule='$matric'") or die(mysqli_error($conn)) ;

$ress=$conn->query("DELETE FROM resits  where fname='$course' and sex='$term' and matricule='$matric'") or die(mysqli_error($conn)) ;
