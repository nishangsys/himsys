 ...
 <form method="post" enctype="multipart/form-data" class="form-horizontal" action="" role="form" >
     ...
     <table class="table table-bordered">
              ...
              <tr><td>Student's Names</td><td><input type="text" name="name" required="required" value="<?php echo $rows['fname'];; ?>" /></td></tr>
               ...
               <tr><td>ID Number</td><td><input type="text" name="idnum" value="<?php echo $rows['idnum']; ?>"  /></td></tr>
              
         
                     
               <tr><td>Date of Issue</td><td><input type="date" name="doi" value="<?php echo $rows['doi']; ?>"  placeholder="dd-mm-yyyy"  /></td></tr>
              
                <tr><td>Place of Issue</td><td><input type="text" name="poi" value="<?php echo $rows['poi']; ?>"  /></td></tr>
              
                
                <tr><td>Region of Origin:</td><td><input type="text" name="region_o" value="<?php echo $rows['region_o']; ?>"  /></td></tr>
         ...
         <tr><td>Country of Birth:</td><td>
          ...
          <option value="<?php echo $rows['doi']; ?>"><?php echo $rows['doi']; ?></option>
...
$idnum=$_POST['idnum'];
$region_o=$_POST['region_o'];

$idnum=$_POST['idnum'];
$poi=$_POST['poi'];
$doi=$_POST['doi'];
$newDate = date("d/m/Y", strtotime($doi)); 
...
poi='$poi',doi='$doi',region_o='$region_o',cob='$country',idnum='$idnum' WHERE matric='".$matric."'") or die(mysqli_error($conn)) ;

echo "<script>alert('Record Created Successfully!'); </script>";

echo '<meta http-equiv="Refresh" content="0; url=../Records/personal.php?cust='.$who.'">';	
...
poi='$poi',doi='$doi',region_o='$region_o',cob='$country',idnum='$idnum' ,matric='".$matric."'") or die(mysqli_error($conn)) ;
