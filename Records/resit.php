    ...
    echo '<tr bgcolor="White">';
      ...
      <td><?php echo $i++; ?></td>
       <td><?php echo $bu['fname']; ?></td>
        ...
        <td>
       <a href=javascript:popcontact('../Records/a44.php?cust=<?php echo $bu['id']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;"><button type="button" class="btn btn-success btn-sm" >Print this Level's</button>
</a>
        |
       <a href=javascript:popcontact('../Records/a4.php?cust=<?php echo $bu['id']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;"><button type="button" class="btn btn-primary btn-sm" >Print All</button>
</a>
        </td>
      </tr>
     <?php } ?> 
