...
levels='$levels',departmet='$class1',sex='$sex',year_id='$ayear',c110='$ids',c101='$start',c102='$end',cxx7='$dept',nationality='Cameroonian',cxx1='$POB',cxx2='$DOB',cxx6='$sch' ") or die(mysqli_error($conn)) ;
