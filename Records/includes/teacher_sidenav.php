           ...
           <i class="icon-plus"></i> Goods Center
                    ...
                    <a href="?debtors&link=Our Debtors" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav" style="color:#f00; font-weight:bold">
                       <i class=" icon-folder-open-alt"></i>  Debtors  
                        ...
                        <li class="panel " >
                    <a href="?summary&link= Debtors Summary " data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav" style="color:#f00; font-weight:bold">
                       <i class=" icon-folder-open-alt"></i>  Debtors Summary 
