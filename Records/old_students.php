...
$d=$conn->query("SELECT * FROM students where fname='$matric' GROUP BY ayear") or die(mysqli_error($conn));
$i=1;
    ...
    echo '<tr bgcolor="White">';
      ...
      <td><?php echo $i++; ?></td>
       <td><?php echo $bu['fname']; ?></td>
        ...
        <td>
      <a href=javascript:popcontact('../Records/admit_returning.php?cust=<?php echo $bu['id']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;"><button class="btn btn-success" >Move to next level</button></a>
