 ...
 else
 {
  ...
  if(isset($_GET['admit'])){
	  ...
	  $id=$_GET['id'];
		  ...
		  $res = $con->query("DELETE FROM lists WHERE names='$name' AND year_id='$ayear'  ") or die(mysqli_error($con));
	    ...
	    $res = $con->query("UPDATE marks_sheet set mat='$mat',admitted='1'  where id='$id' ") or die(mysqli_error($con));
		 ...
		 $res = $con->query("INSERT INTO lists set names='$name',prog='$prog',matric='$mat',year='$year',year_id='$ayear'  ") or die(mysqli_error($con));
