...
?>
 ...
 ?>" /></td></tr>
         ...
         <tr><td>Level</td><td><input type="text" name="lev"  required="required" /></td></tr>
  
   <tr><td>Nationality</td><td><input type="text" name="nation"  required="required" /></td></tr>
...
matricule='$matric' AND year_id='$ayear' AND time='$levels' " ) or die(mysqli_error($conn));


$ats=$conn->query("insert into  students  set  
matricule='$matric',fname='$fname',
levels='$levels',departmet='$class1',sex='$sex',year_id='$ayear',c110='$ids',c101='$year',c102='$year2',cxx1='$POB',cxx2='$DOB',nationality='$nation', cxx6='$sch',cxx7='$dept'") or die(mysqli_error($conn));;



 $query55=$conn->query("insert into historic  set  
matricule='$matric',student_name='$fname',
class='$class1',amountpaid='$paid',amount_paid='$part',expected_amount='$feeamt',balance='$bbm',ids='$ids',date=CURDATE() ,year_id='$ayear',photo='$nation' ,time='$levels' " ) or die(mysqli_error($conn));
