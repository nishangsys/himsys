    ...
    echo '<tr bgcolor="White">';
      ...
      <td><?php echo $i++; ?></td>
       <td><?php echo $bu['fname']; ?></td>
        ...
        <td>
     <a href=javascript:popcontact('../Records/editt.php?cust=<?php echo $bu['id']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;"><button class="btn btn-success" >Edit Me</button></a> |
     
       
          <a href=javascript:popcontact('../Records/edit_dept.php?cust=<?php echo $bu['id']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;"><button class="btn btn-primary" >Change Dept</button></a>
        </td>
      </tr>
     <?php } ?> 
    </tbody>
