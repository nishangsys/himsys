...
class='$class1',amountpaid='$paid',amount_paid='$part',expected_amount='$feeamt',balance='$bbm',ids='16',date='$date' ,year_id='$ayear',photo='$matric' ,time='$levels' " ) or die(mysqli_error($conn));
 ...
 $daily=$con->query("INSERT INTO daily set cust_id='$matriculex',room='$room',day='$day',staffname='$fname',discount='$reg',amt='$part',date='$date',month='$month',year='$ayear',reason='fees',qty='1',area='1',price='$paid',total='$part',owed='$bbm',company='$bank',paidto='$active',
