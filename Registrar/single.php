...
<body class="padTop53 " >
    ...
    <div id="wrap">
		...
		$reason=$_GET['reason'];
		 ...
		 $d=$con->query("SELECT SUM(amt),staffname,company,date,paidto,cust_id,id,paidtou FROM daily where  year='$ayear' and reason='fees' and company!='' GROUP BY staffname order by staffname") or die(mysqli_error($con));
$i=1;
?>
 <thead>
                                        <tr>
      ...
      <tr>
		...
		$reason=$_GET['reason'];
		 ...
		 $d=$con->query("SELECT SUM(amt) FROM daily where year='$ayear' and reason='fees' and company!='' GROUP BY year") or die(mysqli_error($con));
