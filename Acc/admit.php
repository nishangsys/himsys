...
while($bu=$d->fetch_assoc()){
	echo $fees1=$bu['fees'];
               ...
               <tr><td>Academic Year</td><td><input type="text" name="year_id" readonly="readonly" value="<?php  echo $year_id;
...
levels='$levels',departmet='$class1',sex='$sex',year_id='$year_id',c110='$ids',c101='$year',c102='$year2',cxx7='$city',cxx6='$guide',cxx1='$POB',cxx2='$DOB' ") or die(mysqli_error($conn)) ;
