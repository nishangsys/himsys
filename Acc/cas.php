...
<div class="well">
 <form class="form-horizontal" action="" method="post" name="form">
   ...
   <div class="form-group">
      ...
      <div class="col-sm-10">
  <select class="form-control" name="mode" style="width:300px" required>
  
  <option></option>
  <option  value="scholarship">Scholarship</option>
  <?php
							
								$result = $con->query("SELECT * FROM modes order by name") or die(mysqli_error($con));
    ...
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
		...
		$reason=$_POST['mode'];
		 ...
		 $d=$con->query("SELECT * from daily where rec>0 and purpose='$reason' and year='".$_GET['year_id']."' order by id") or die(mysqli_error($con));
$i=1;
?>
 <thead>
                                        <tr>
      ...
      <tr>
		 ...
		 $d=$con->query("SELECT SUM(rec) FROM daily where  year='$year_id' and rec>0 and purpose='$reason' GROUP BY year") or die(mysqli_error($con));
