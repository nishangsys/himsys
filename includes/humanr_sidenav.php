            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel active">
                    ...
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle collapsed" data-target="#form-nav">
                        <i class="icon-save"></i> Bank Fees Reports
...
?>
                        <li class=""><a href="?reports&link=<?php echo $bu['company']; ?> Reports&reason=<?php echo $bu['company']; ?>"><i class="icon-angle-right"></i> <?php echo $bu['company']; ?> </a></li>
                     <?php } ?>
