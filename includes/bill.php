...
<script language="JavaScript" src="../js/pop-up.js"></script>
   ...
   <script>
	function ajax(){
		...
		req.open('GET','../laundry/billing.php?tabs=<?php echo $table=$_GET['id']; ?>&adds=<?php echo $_GET['adds']; ?>&reduce=<?php echo $_GET['reduce']; ?>&good=<?php echo $_GET['our_staff']; ?>&dept=<?php echo $_GET['dep']; ?>',true); 
		req.send();
