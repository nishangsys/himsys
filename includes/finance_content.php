      ...
      <!--PAGE CONTENT -->
        ...
        <div class="col-sm-4">
          <div class="well">
         <h4 style="font-family:Georgia, 'Times New Roman', Times, serif; color:#060">  <a class="btn btn-success btn-xs btn-circle" style="width: 10px;height: 12px;"> </a> FINANCIAL OFFICER  <?php echo $_GET['dept']; ?></h4>
          </div>
        </div>
        <div class="col-sm-8">
          <div class="well">
