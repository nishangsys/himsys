...
?>   
 ...
 else
 {
    echo '<tr bgcolor="lightcyan">';
		...
		?>
           <td><?php  echo $i++; ?></td>
                                            <td><a href="?form_b&delete=<?php echo $bu['id']; ?>&matric=<?php echo $user; ?>&year_id=<?php echo $ayear; ?>&name=<?php echo $bu['ayear']; ?>" style="font-weight:bold; color:#033" onclick="return confirm('Are you sure about you wish to delete <?php echo $bu['subj']; ?> ')"><?php echo $bu['subj']; ?></a></td>
