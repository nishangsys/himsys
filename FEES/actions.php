...
$bbm=$_POST['feeamt']-$_POST['schamt']-$_POST['part'];
$all=$part+$reg;
...
$query5523=$con->query("insert into historic  set  
matricule='',student_name='$fname',
class='$class1',amount_paid='$allpaid',expected_amount='$feeamt',balance='$bbm',ids='16',date=CURDATE() ,year_id='$ayear',photo='$matric' ,time='$levels',xxx='$scholar',amountpaid='$schamt' " ) or die(mysqli_error($con));
...
echo '<meta http-equiv="Refresh" content="0; url=first.php?scholarship&link=Scholarships">';	
