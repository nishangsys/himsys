...
function checkAvailability() {
  ...
  if(isset($_GET['22'])){
   $your=$_POST['dept'];
	 $count=$_POST['sex'];
	  $name=$_POST['sch'];
	   $a=mysql_query("SELECT * from classes WHERE class='$your' GROUP BY class ") or die(mysql_error());
  ...
  <div class="col-sm-12">
  <h3 style="background:#f00; color:#FFF; padding:5px 5px">Receiving Scholarships From <?php echo $name; ?></h3>
      <div class="well">
 <form class="form-horizontal" action="actions.php" method="post" name="form">
  ...
  <input name="username" type="text" id="username" class="demoInputBox" onBlur="checkAvailability()" style="width:65%" /><span id="user-availability-status"></span>    
