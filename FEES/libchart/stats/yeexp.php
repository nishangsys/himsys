                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-table">   
                            ...
                            <script type="application/javascript">
                                ...
                                $query = mysql_query("select SUM(amount_paid) from historic WHERE year_id='$ayear' GROUP BY class") or die(mysql_error());
                                ...
                                chart1.labels = [
                                <?php
                                $query = mysql_query("select staffname from historic WHERE year_id='$ayear' GROUP BY class") or die(mysql_error());
                                while ($row = mysql_fetch_array($query)) {
                                    ?>
