...
$("#suggesstion-box").hide();
  ...
  ?>
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
       ...
       <a href="?name=<?php echo $name; ?>&id=<?php echo  $row ['id']; ; ?>&year_id=<?php echo $ayear; ?>&levelss=<?php echo $lev; ?>">      <button type="button" class="btn btn-primary btn-sm">UPDATE</button> </a> |      <a href="?upfin&name=<?php echo $name; ?>&fin=<?php echo  $row ['id']; ; ?>&year_id=<?php echo $ayear; ?>&levelss=<?php echo $lev; ?>" >      <button type="button" class="btn btn-success btn-sm">UPDATE FINANCE</button> </a> </td>     
