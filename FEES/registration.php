...
?>
    ...
    <span style="color:#ff0; font-weight:bold">  <?php echo $level; ?></span> Registration REPORTS 
...
<script type="text/javascript" charset="utf-8" language="javascript" src="js/DT_bootstrap.js"></script>
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                          ...
                          <th style="text-align:center;">Department</th>
                            ...
                            <tbody>
								<?php
							$today=date('d-m-Y');
								$result= $conn->query("select  * from historic where year_id='$ayear' and olddebt>0 order by student_name" ) or die (mysqli_error($conn));
								$num=1;
				while ($row= $result->fetch_assoc() ){
                            ...
                            <td style="text-align:center; word-break:break-all; width:20px;"> <?php echo $num++; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:300px; text-transform:capitalize"> <?php echo $name=$row ['student_name']; ?></td>
                      	...
                      	<td style="text-align:center; word-break:break-all; width:250px;"> <?php echo $row ['amountpaid']; ?></td>	
                                             <td style="text-align:center; word-break:break-all; width:100px; color:#f00; font-weight:b"> <?php echo $row ['olddebt']; ?></td>
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
						...
						$result= $dbcon->query("select  SUM(rec) as totals from daily where date='$today'  group by date" ) or die (mysqli_error($dbcon));
								$num=1;
				while ($row= $result->fetch_assoc() ){
								$id=$row['id'];
								?>
...
$result= $dbcon->query("DELETE FROM debtors where roll='$dele'" ) or die (mysqli_error($dbcon));
