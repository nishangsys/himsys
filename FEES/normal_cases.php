...
function checkAvailability() {
 ...
 <form class="form-horizontal" action="../Fees/action.php" method="post" name="form">
  ...
  <input name="username" type="text" id="username" class="demoInputBox" onBlur="checkAvailability()" style="width:65%; border:2px solid#f00" required="required" value="<?php echo $_GET['ydept'];?>"><span id="user-availability-status"></span>    
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="email"  name="class"  readonly value="<?php echo $_GET['yprogram'];?>">
      </div>
    </div>
   ...
   <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="email"  name="ayear" value="<?php echo $ayear; ?><?php echo $ayear; ?>" readonly>
      </div>
    </div>
