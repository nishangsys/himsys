...
define ("DB_NAME","
schhol_finance"); // set database name
...
$con->query("update users set md5_id='$md5_id' where id='$user_id'");
  ...
  <tr> 
	...
	?></p>
	 ...
	 ?> 
      ...
      <form action="" method="post" name="regForm" id="regForm" style="margin-top:-30px">
        <table width="100%" style="line-height:1.6" border="0" cellpadding="3" cellspacing="3" class="forms">
          <tr> 
            <td colspan="2">Your Name / Company Name<span class="required"><font color="#CC0000">*</font></span><br> 
              <input name="full_name" type="text" id="full_name" size="40" readonly class="required" value="HIMS"></td>
          </tr>
          ...
          <tr> 
           ...
           <tr> 
            ...
            <tr><td>Level</td><td><select type="hidden" name="level" style="width:220px" />
                ...
                <option value="6">Central Casheir</option>
                     <option value="7">CNPS Clerk</option>
                <option value="17">Hospital Accountant</option>
                   <option value="8">HIMS Staff control</option>
                <option value="101">School Accountant</option> 
               <option value="100">Finance Officer</option>        
