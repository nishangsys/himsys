  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <div class="alert alert-danger">
        ...
        <?php echo $_GET['our_wards']; ?></strong> OF <?php echo $_GET['dep']; ?></a>.
      </div>
...
<iframe src="my_sales.php?name=<?php echo $_GET['our_wards'];  ?>&id=<?php echo $_GET['id']; ?>&dept=<?php echo $_GET['dep'];  ?>" style="border:none; width:770px; height:1200px; margin-top:0px"></iframe> 
    </div>
