...
if(isset($_POST['SubmitUpdate'])) {
	...
	$a = $con->query("SELECT SUM(price*qty) as totbill FROM basket where tab='".$_GET['id']."' and status='0' GROUP BY tab") or die(mysqli_error($con));
	...
	$update_cust = $con->query("UPDATE  customers SET debts='$totdebts' WHERE client_id='$who'  ")  ;
	
	
		$daily=mysql_query("INSERT INTO daily set cust_id='$who',room='',amt='".$_POST["price$i"]."',reason='".$_POST["product$i"]."',qty='".$_POST["qty$i"]."',price='".$_POST["price$i"]."',total='".$_POST["total$i"]."',
			owed='".$_POST["total$i"]."',date='".$_POST["date$i"]."',month='$month',year='$year',area='',time='$time',paidto='$paidto',purpose='pharmacy staff' ,idds='',discount='',staffname='$name'") or die(mysql_error());
			
			
			
			
	
		$acv=$conn->query("INSERT INTO daily set cust_id='$who',room='',amt='".$_POST["price$i"]."',reason='".$_POST["product$i"]."',qty='".$_POST["qty$i"]."',price='".$_POST["price$i"]."',total='".$_POST["total$i"]."',
			owed='".$_POST["total$i"]."',date='".$_POST["date$i"]."',month='$month',year='$year',area='0',time='$time',paidto='$paidto',purpose='pharmacy Bills' ,idds='0',discount='',staffname='$name'") or die(mysqli_error($conn));
...
<h1 style="background:#088389; text-align:center; font-size:24px; padding:20px 0px; color:#fff;">Druigs Validation for <span style="color:#ff0"> Total Bill: 
