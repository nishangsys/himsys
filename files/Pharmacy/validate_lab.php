...
if(isset($_POST['SubmitUpdate'])) {
	...
	//daily records
		...
		$daily=mysql_query("INSERT INTO daily set cust_id='$who',room='',amt='".$_POST["price$i"]."',reason='".$_POST["product$i"]."',qty='".$_POST["qty$i"]."',price='".$_POST["price$i"]."',
			...
			owed='".$_POST["total$i"]."',date='".$_POST["date$i"]."',month='$month',year='$year',area='0',time='$time',paidto='$paidto',purpose='pharmacy Bills' ,idds='1',discount='',staffname='$name'") or die(mysqli_error($conn));
