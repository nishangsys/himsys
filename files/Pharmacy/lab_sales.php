...
<?php
 $sector=$_GET['supp'];
?>
<form method="post"  action="action12.php?name=<?php echo $name; ?>&dept=<?php echo $dept; ?>&id=<?php echo $id; ?>">
      			...
      			<table class="table table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="alltotal[]" id="alltotal_1" class="form-control alltotalLinePrice" autocomplete="off" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" style="background:#f00; color:#fff"></td>
...
?>
    ...
    <script src="../js/autoplab.js"></script>
