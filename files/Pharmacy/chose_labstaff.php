  ...
  <div class="row content">
    ...
    <div class="col-sm-12 text-left"> 
      <div class="alert alert-danger">
       ...
       <?php
	   $today=date('d-m-Y');
	  $do12=$con->query("SELECT * from customers where reg_date='$today' and gname='lab' order by client_id DESC LIMIT 5 ") or die(mysqli_error($con));
	  $i=1;
 ...
 else
 {
    echo '<tr bgcolor="AliceBlue">';
        ...
        <td><?php echo $name=$df['stu_name']; ?></td>
         ...
         <td>
            <a href="?my_labtec=<?php echo $name; ?>&dep=<?php echo $df['class']; ?>&id=<?php echo $df['client_id']; ?>&name=<?php echo $name; ?>">
