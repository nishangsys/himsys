...
$shape=$_POST['name'];
	  ...
	  $dfGu=$con->query("DELETE FROM sitems WHERE name='$shape' and year_id='$year_id'") or die(mysqli_error($con));
	  $dfGu=$con->query("INSERT INTO  sitems SET name='$shape',year_id='$year_id'") or die(mysqli_error($con));
 ...
 <div class="form-group">
  ...
  <div class="table-responsive">
	  ...
	  $year=date('Y');
	   ...
	   $d=$con->query("SELECT * FROM sitems where year_id='$year_id' ") or die(mysqli_error($con));
$i=1;
?>                       
