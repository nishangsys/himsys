    ...
    echo '<tr bgcolor="White">';
      ...
      <td><?php echo $i++; ?></td>
       <td><?php echo $bu['fname']; ?></td>
        ...
        <td>
       <a href=javascript:popcontact('../Affairs/addmarks.php?cust=<?php echo $bu['id']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;"><button type="button" class="btn btn-success btn-sm" >Receive Items</button>
</a>
        |
       <a href=javascript:popcontact('../Affairs/give.php?cust=<?php echo $bu['id']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;"><button type="button" class="btn btn-danger btn-sm" >Give Items</button>
</a>
        </td>
      </tr>
     <?php } ?> 
