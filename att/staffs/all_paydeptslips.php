...
$mat=$_GET['yourown'];
	...
	$year=$_GET['year'];;
	$dept=$_GET['all'];
	$d=mysql_query("SELECT * FROM payslips,voucher where payslips.month='$month'  AND payslips.matric=voucher.matric and payslips.year='$year' and payslips.dept='$dept' GROUP BY payslips.matric") or die(mysql_error());
