    ...
    <a class="btn btn-primary" href="<?PHP echo $_SERVER['_SELF']; ?>?register_staff"  style="text-decoration:none; color:#fff; padding:5px 10px">Click Here To Add </a>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from staffs,payslips WHERE staffs.banned='0' and staffs.matric=payslips.matric group by payslips.matric order by payslips.month DESC" ) or die (mysql_error());
								$i=1;
