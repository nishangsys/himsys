	...
	<h1 class="h1" style="font-size:14px">PRINT A COPY OF SALARIES PAYMENTS DETAILS</h1>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from payslips  WHERE year='$year' and month='$month' GROUP BY month,year order by month DESC" ) or die (mysql_error());
								$i=1;
             ...
             <td style="text-align:center; word-break:break-all; width:10px;"> <?php echo $i++; ?></td>
                            ...
                            <a href="printmonth_print.php?month=<?php echo $row['month']; ?>&dept" target="_blank" class="btn btn-info" style="color:#fff">Print a Copy</a>
