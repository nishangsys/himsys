...
$query 	= mysql_query("SELECT * FROM `all_categories` ORDER BY id ASC"); // Select from the table
...
if(isset($_POST['SubmitUpdate'])) {
	...
	$amt = $_POST['total']; // Get the total rows
	for($i=1; $i<=$amt; $i++) {
		$update = mysql_query("UPDATE `all_categories` SET `amt` = '".$_POST["amt$i"]."',
    ...
    ?>
        ...
        ?>
            ...
            <tr>
                ...
                <td><input type="text"name="name<?php echo $i; ?>" style="width:120px" />               
                </td>
