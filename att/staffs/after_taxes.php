...
leaves='".$_POST["leaves$i"]."',trans='".$_POST["trans$i"]."',senior='".$_POST["senior$i"]."' ") or die(mysql_error()); // loop the mysql_query values to avoid more server loding time
            ...
            <tr>
				...
				echo $ccff= round($salier/100);
				  ...
				  ?>" style="width:60px" class="input" readonly /></td>
                                      ...
                                      <td><input type="text" name="taxes<?php echo $i; ?>"  style="width:50%" class="input"  /></td>
