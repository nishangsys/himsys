...
if($section=='18'){
 ...
 ?>
   ...
   <script>
	...
	//////////////////update basket	 	
	$un1=$con->query("UPDATE $db_basket set status='3' where tab='$add' and status='1' ") or die(mysqli_error($con));
	
	$da=mysql_query  ("DELETE FROM $db_basket WHERE qty<1") or die(mysql_error());
	 }
