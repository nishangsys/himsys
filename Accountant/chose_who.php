  ...
  <div class="row content">
    ...
    <div class="col-sm-12 text-left"> 
      <div class="alert alert-danger">
       ...
       <?php
	   $today=date('d-m-Y');
	  $do12=$con->query("SELECT * from names where date='$today' and sector='others' order by id DESC LIMIT 5 ") or die(mysqli_error($con));
	  $i=1;
 ...
 else
 {
    echo '<tr bgcolor="AliceBlue">';
        ...
        <td><?php echo $name=$df['name']; ?></td>
         ...
         <td>
            <a href="?cash_sales=<?php echo $name; ?>&dep=<?php echo $df['dept']; ?>&id=<?php echo $df['id']; ?>">
