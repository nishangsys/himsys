...
<div class="col-sm-8 text-left"> 
      <div class="alert alert-danger">
        <strong>The system says!</strong> Choose a staff to sell to
      </div>
...
$name=$_POST['names'];
		   ...
		   $mk=$con->query("INSERT INTO names set name='$name',dept='$dept',date='$date',sector='lab' ") or die(mysqli_error($con));
...
<a href="?my_labtec&branch=<?php echo $branch; ?>&name=<?php echo $df['name']; ?>&id=<?php echo $df['id']; ?>" onclick="return (confirm('Are you sure you wish supply to <?php echo $name;  ?>'))">
 ...
 <?php
	   if(isset($_GET['my_labtec'])){
		   $date=date('d-m-Y');
	    $mk=$con->query("INSERT INTO names set name='".$_GET['my_labtec']."',dept='$dept',date='$date',sector='lab' ") or die(mysqli_error($con));
