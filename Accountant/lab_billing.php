...
$dept=$_GET['dept'];
    ...
    Print Receipt
        ...
        <a href=javascript:popcontact('validate_lab.php?roll=<?php echo $table; ?>&name=<?php echo $table; ?>') style="color:#fff; text-decoration:blink">   
  ...
  <a href="index.php?my_labtec=<?php echo $name; ?>&dep=<?php echo $dept; ?>&id=<?php echo $table; ?>&adds=<?php echo $rows['id']; ?>&name=<?php echo $name; ?>">
 ...
 <a href="index.php?my_labtec=<?php echo $name; ?>&dep=<?php echo $dept; ?>&id=<?php echo $table; ?>&reduce=<?php echo $rows['id']; ?>&name=<?php echo $name; ?>">
