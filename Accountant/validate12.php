...
if(isset($_POST['SubmitUpdate'])) {
	...
	//daily records
		...
		$daily=mysql_query("INSERT INTO daily set cust_id='$who',room='',amt='".$_POST["price$i"]."',reason='".$_POST["product$i"]."',qty='".$_POST["qty$i"]."',price='".$_POST["price$i"]."',
			rec='".$_POST["total$i"]."',date='".$_POST["date$i"]."',month='$month',year='$year',area='',time='$time',paidto='$paidto',purpose='pharmacy cash' ,idds='',discount=''") or die(mysql_error());
...
<h1 style="background:#088389; text-align:center; font-size:24px; padding:20px 0px; color:#fff;">Goods Validation for <span style="color:#ff0">  <?php echo $name; ?> </span></h1>
