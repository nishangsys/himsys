		...
		<th width="3%">Quantity</th>
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="quantity[]" required id="quantity_1" class="form-control changesNo" autocomplete="off" onBlur="doCalc(this.form)" onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" maxlength="3" required></td>
