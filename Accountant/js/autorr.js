...
$(".addmore").on('click',function(){
	...
	html += '<td><input type="text" data-type="productCode" name="itemNo[]" id="itemNo_'+i+'" class="form-control autocomplete_txt" readonly="readonly" autocomplete="off"  ></td>';
	...
	html += '<td><input type="text" readonly="readonly" data-type="cost" name="cost[]" id="cost_'+i+'" class="form-control autocomplete_txt" autocomplete="off" ></td>';
