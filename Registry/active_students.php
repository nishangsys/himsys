...
<form id="hdTutoForm" method="POST" action="../Registry/all_active.php" target="new">
...
while($bus=$ds->fetch_assoc()){
    ...
    <div class="form-group col-md-3"><br>
      <input type="submit" class="next btn btn-primary" value="GET ACTIVE STUDENTS" name="ok" /> 
    </div>
