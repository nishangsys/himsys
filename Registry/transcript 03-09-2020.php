...
<td>
	...
	if($idkl==9){
		?>	
         ...
         <a href="../Registry/Transcript/PBH/index.php?xxc=<?php echo $bu['roll']; ?>&link=Add Subject " target="new">
    ...
    <button class="btn btn-xs btn-primary" >
     ...
     <a href="../Registry/Transcript/BUILD/index.php?xxc=<?php echo $bu['roll']; ?>&link=Add Subject " target="new">
  ...
  <a href="../Registry/Transcript/hnd.php?xxc=<?php echo $bu['roll']; ?>&link=Add Subject " target="new"> <button class="btn btn-xs btn-danger" >
    ...
    <a href="../Registry/Transcript/PBHT/index.php?xxc=<?php echo $bu['roll']; ?>&link=Add Subject " target="new"> <button class="btn btn-xs btn-danger" >
																<i class="ace-icon fa fa-check bigger-120"></i> Print Transcript 
															</button></a>      
        <?php } 
  ...
  <a href="../Registry/Transcript/index.php?xxc=<?php echo $bu['roll']; ?>&link=Add Subject " target="new">
    ...
    <button class="btn btn-xs btn-success" >
       ...
       <a href="../Registry/Transcript/single_page.php?xxc=<?php echo $bu['roll']; ?>&link=Add Subject " target="new">
