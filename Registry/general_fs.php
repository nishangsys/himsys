...
while($bu=$d->fetch_assoc()){
	...
	$d=$dbcon->query("SELECT *  from  my_marks,courses where  my_marks.dept='$dept' and  my_marks.matric=courses.matricule and  my_marks.ayear=courses.db1 and  my_marks.ayear='".$ayear."'  and courses.c117='100' and  my_marks.sem='$sem' AND  my_marks.levels='$level' and  my_marks.levels=courses.levels  GROUP BY  my_marks.matric") or die(mysqli_error($dbcon));
