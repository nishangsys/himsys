...
if(!empty($_FILES['excelfile']['name']))
{
        ...
        && $_FILES['excelfile']['size'] > 0 )
    {
		...
		$prog =mysql_real_escape_string(  $row[8]);
                   $check= $dbcon->query("SELECT * FROM  my_marks   WHERE matric='$MTAS' and code='$code' and sem='$sem'  and levels='$level' and ayear='$ayear'  ") or die(mysqli_error($dbcon));
...
$do=$dbcon->query("INSERT INTO  my_marks SET code='$code', matric='$MTAS',credit='$dept',sem='$sem',ayear='$ayear', levels='$level',  ca='$ca',exam='$exams',dept='$prog'  ") or die(mysqli_error($dbcon));
