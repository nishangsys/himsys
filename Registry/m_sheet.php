...
<div class="alert alert-success">
  <strong>Generate Marks Sheets </strong> 
</div>
...
<form id="hdTutoForm" method="POST" action="../Registry/mark_sheet.php" target="new">
 ...
 <label for="inputEmail4">Program</label>
   ...
   <option value="1">1  </option>
      <option value="2">2 </option>
	   ...
	   $ds=$dbcon->query("SELECT * from  my_marks WHERE ayear>=300 GROUP BY ayear order by ayear desc") or die(mysqli_error($dbcon));
while($bus=$ds->fetch_assoc()){
    ...
    <div class="form-group col-md-3"><br>
      <input type="submit" class="next btn btn-primary" value="BUILD MARKS SHEET " name="ok" /> 
    </div>
