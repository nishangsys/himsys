...
<div class="alert alert-success">
  <strong>Generating Graduation Lists</strong> 
</div>
...
<form id="hdTutoForm" method="POST" action="../Registry/graduation_list.php" target="blank">
...
while($bus=$ds->fetch_assoc()){
    ...
    <div class="form-group col-md-3"><br>
      <input type="submit" class="next btn btn-primary" value="BUILD GRADUATION LISTS" name="ok" /> 
    </div>
