...
$rows = mysql_query("SELECT fname,departmet,matricule,db1,levels,cxx4 from courses where  db1='".$_GET['ayear']."' and cxx4='Nigerian' order by fname") or die(mysql_error());
