...
?>
	<page size="A4" layout="landscape"  >
        <div class="main" style="height:auto; overflow:hidden; border:1px solid#000; border-bottom:1px solid#000; outline:#FFF;  ";
		  >
	...
	if($page==1){
	 ...
	 include 'sec_header.php';
          ...
          <div class="title"><?php echo $p_names; ?> YEAR</div>
      ...
      <!------Second Sequence----------->
          ...
          <div class="title">THIRD SEQUENCE</div>
           ...
           Grade
            ...
            <div  class="patition" style="border:none; width:35px; line-height:none;height:367px; border-bottom:1px solid#000 ">
...
?>
	...
	?>
     ...
     <br />Student's No: <span style="font-size:14px; font-weight:bold"><?php echo $matric; ?> </span>
         </div>
     
     
     <div class="box1_left" style=" border-top:none; margin-left:0px; border-left:none; width:170px">
            <br />Date Printed: <?php echo date('d-m-Y'); ?>
            
      </div>
      
       <div class="box1_left" style=" border-top:none; margin-left:0px; border-left:none; width:98px; border-right:none">
