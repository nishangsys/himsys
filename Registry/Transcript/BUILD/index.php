...
$c=$dbcon->query("SELECT * FROM years,students WHERE   students.matricule='".$matric."' AND students.year_id=years.id and students.dept_id='$ydept' order by students.year_id ASC") or die(mysqli_error($dbcon));
	$page=1;
	$page_num=$c->num_rows;
while($row=$c->fetch_assoc()){
echo $dept=$row['dept_id'];
	 ...
	 include 'sec_header.php';
          ...
          <div  class="patition" style="border-left:none; border-top:0px; line-height:none; width:59PX;">
           ...
           Grade Point
             ...
             <span style="font-weight:bold"><?php 	echo $p_names; ?> YEAR - SECOND SEMESTER <?PHP echo $row['year_id']; ?></span>
            <div style="clear:both"></div>
