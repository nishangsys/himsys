   ...
   <script>
	function ajax(){
		...
		req.open('GET','bi.php?our_satff=<?php echo $_GET['our_staff']; ?>&tabs=<?php echo $table=$_GET['req_id']; ?>&adds=<?php echo $_GET['adds']; ?>&reduce=<?php echo $_GET['reduce']; ?>&good=<?php echo $_GET['our_staff']; ?>&dept=<?php echo $_GET['dep']; ?>',true); 
		req.send();
