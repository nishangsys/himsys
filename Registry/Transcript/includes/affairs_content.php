	...
	if(isset($_GET['items'])){
	include '../Affairs/items.php';
	}
	if(isset($_GET['fitems'])){
	include '../Affairs/fitems.php';
	}
	if(isset($_GET['saveitems'])){
	include '../Affairs/rfitems.php';
	}
	if(isset($_GET['receive'])){
	include '../Affairs/receive.php';
	}
	if(isset($_GET['receivea'])){
	include '../Affairs/record.php';
	}	
		if(isset($_GET['reports'])){
	include '../Affairs/reports.php';
	}			?>
