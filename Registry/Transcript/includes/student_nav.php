...
$dd=$con->query("SELECT * FROM subjects where db1='$ydept' ") or die(mysqli_error($con));
    ...
    <div id="wrap" >
        ...
        <div id="top">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <span class="label label-success"><?php $dn=$con->query("SELECT COUNT(ayear) as allm FROM news where ayear='$ayear' and dept='".$pdept."'  ") or die(mysqli_error($con));
			...
			echo  $total= $bun['allm'];
                        ...
                        <?php $dn=$con->query("SELECT * FROM news where ayear='$ayear' and dept='".$pdept."'  ") or die(mysqli_error($con));
			...
			?>
                    ...
                    <li class="chat-panel dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <span class="label label-info"><?php $dn=$con->query("SELECT COUNT(yourid) as allm FROM chat where ayear='$ayear' and sentby like '%".$ydept."%' and levels='$level'  ") or die(mysqli_error($con));
...
<?php $dn=$con->query("SELECT * FROM chat where ayear='$ayear' and sentby like '%".$ydept."%' and levels='$level' order by id DESC LIMIT 10  ") or die(mysqli_error($con));
