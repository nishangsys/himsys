...
if (mysqli_connect_errno())
  ...
  $dbcon = mysqli_connect('localhost','nishang','google1234','2019_university');
...
if (mysqli_connect_errno())
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
    ...
    $staffdb = mysqli_connect('localhost','nishang','google1234','staffs');
...
if (mysqli_connect_errno())
  ...
  $conn = mysqli_connect('localhost','nishang','google1234','2019_university');
...
define ("DB_NAME","2019_university"); // set database name
