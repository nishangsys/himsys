...
body{
	...
	if(isset($_GET['student_Registry'])){
		include 'student_Registry.php';
	}
	...
	if(isset($_GET['scholars'])){
	 ...
	 if(isset($_GET['fRegistry'])){
		include 'fRegistry.php';
	}
	...
	if(isset($_GET['my_Registry'])){
		include 'my_Registry.php';
	}
	if(isset($_GET['my_tRegistry'])){
		include 'my_tRegistry.php';
	}
	if(isset($_GET['all_Registry'])){
		include 'all_Registry.php';
	}
	...
	if(isset($_GET['fb'])){
	include '../Registry/fb.php';
	}
	if(isset($_GET['regs'])){
	include '../Registry/regs.php';
	}
	...
	include '../Registry/genc_lists.php';
	}
			?>
