      ...
      <!--PAGE CONTENT -->
        ...
        <div class="col-sm-8">
          <div class="well">
            ...
            <span style="background:#000; color:#ff0; padding:10px 10px">Breaking News: </span> &nbsp;<?php $dn=$con->query("SELECT * FROM news where ayear='$ayear' and dept='".$pdept."'  order by id  DESC limit 2  ") or die(mysqli_error($con));
