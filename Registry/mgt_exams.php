...
?>
        ...
        <a href="?uploading_exams&did=<?php echo $bu['programe_id']; ?>&id=<?php echo $bu['id']; ?>&ayear=<?php echo $ayear; ?>&level=<?php echo $bu['level_id']; ?> &sch_id=2"><button class="btn btn-success"   >Upload <?php echo $bu['course_code']; ?> Exams Mark</button>
