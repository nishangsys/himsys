...
<head>
    <meta charset="UTF-8" />
    <title>BUIB SCHOOL SYSTEM </title>
...
<?php
include '../includes/registry_nav.php';
?>
...
<?php
include '../includes/registry_sidenav.php';
?>



<?php
include '../includes/registry_content.php';
?>
        <?php
include '../includes/t_sidebars.php';
?>
    </div>
