...
include  '../includes/dbc.php';
	...
	$d=$dbcon->query("SELECT *  from courses where  departmet='$dept' and db1='$ayear' and levels='$level'    GROUP BY matricule ") or die(mysqli_error($dbcon));
	$page=1;
...
<?php } ?></div>
	...
	$ds=$dbcon->query("SELECT *  from  my_marks where matric='".$row['matricule']."' and ayear='".$row['db1']."'  and sem='2' AND ca!='' order by code ") or die(mysqli_error($dbcon));
