<h3>Printing an Individual Results Slip</h3>
      <?php
	  $year=date('Y');
...
$sectors=mysqli_real_escape_string($dbcon,$_POST['names']);
           ...
           $d=$dbcon->query("SELECT * FROM  years,levels,special,students WHERE matricule='$name'
...
<?php echo $i++; ?>
    ...
    <a href="first_sem.php?sem=1&xxc=<?php echo $bu['id']; ?>&link=Add Subject " target="new">
    
    <button class="btn btn-xs btn-primary" >
																<i class="ace-icon fa fa-check bigger-120"></i> First Semester 
															</button></a> |

  <a href="first_sem.php?sem=2&xxc=<?php echo $bu['id']; ?>&link=Add Subject " target="new">
    
    <button class="btn btn-xs btn-success" >
																<i class="ace-icon fa fa-check bigger-120"></i> Second Semester 
															</button></a>
	                                                            
                                                                 <a href="first_sem.php?sem=3&xxc=<?php echo $bu['id']; ?>&link=Add Subject " target="new">
