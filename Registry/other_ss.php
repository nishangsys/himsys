 ...
 <form class="form-horizontal" action="" method="post" >
    <div class="form-group">
      ...
      <div class="col-sm-10">
       ...
       <?php
	   $d=$con->query("SELECT * FROM settings GROUP BY prog order by prog ") or die(mysqli_error($con));
	   while($df=$d->fetch_assoc()){
	   ?>
    <option value="<?php echo $df['prog']; ?>"><?php echo $df['prog']; ?></option>
    <?php } ?>
...
input,select{
 ...
 <form method="post" enctype="multipart/form-data" class="form-horizontal" action="../Registry/OTHs.php" role="form" >
...
levels='$levels',departmet='$class1',sex='$sex',db1='$db1',c110='$ids',c101='$year',c102='$year2',cxx7='$dept',cxx4='Cameroonian',cxx1='$POB',cxx2='$DOB' ") or die(mysqli_error($conn)) ;
