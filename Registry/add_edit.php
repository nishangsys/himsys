...
<?php echo $i++; ?>
    ...
    <a href="?edit_mks&matric=<?php echo $bu['matricule']; ?>&ayear=<?php  echo $bu['year_id'];  ?>&name=<?php  echo $bu['fname'];  ?> " >
    
    <button class="btn btn-xs btn-primary" >
																<i class="ace-icon fa fa-check bigger-120"></i> Edit Exams/Ca Marks			</button></a> |
     
     
    
     
  
    <a href=javascript:popcontact('../Registry/Marks/index.php?code=<?php echo $bu['id'];?>&level=<?php echo $bu['level_id']; ?>') style="color:#fff; text-decoration:blink text-align:center; font-weight:bold;">
    <button class="btn btn-xs btn-success" > Add missing Subjects  </button></a>                                                   
