...
<div style="   width:100%; float:left; text-align:center;  
  ...
  border:1px DASHED#000; font-size:16px; padding:5px 0px; text-transform:uppercase  "> p.o box 77 bokoko ,buea</div></div>
    ...
    <div style="   width:100%; float:left; text-align:center;  
  border:1px DASHED#000; font-size:16px;padding:5px 0px; font-weight:bold;   ">FIRST SEMESTER <?PHP echo $row['db1']; ?>  INDIVIDUAL RESULTS SLIP</div>
    <!--left box------->
   <div class="left_box">
...
<?php } ?></div>
	...
	$ds=$dbcon->query("SELECT *  from  my_marks where matric='".$row['matricule']."' and ayear='".$row['db1']."'  and sem='1' 
	order by code ") or die(mysqli_error($dbcon));
   ...
   <td style="font-size:10px"><?php
    ...
    <div class="footer_box">
			...
			/////Credit Earned
		    $as=$dbcon->query("SELECT * FROM  my_marks where   matric='".$row['matricule']."' and ayear='".$row['db1']."' and sem='1'  and valid='1' ") or die(mysqli_error($dbcon));
