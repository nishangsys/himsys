...
while($bu=$d->fetch_assoc()){
	 ...
	 //////////select academic year//////////////
$d=$dbcon->query("SELECT * FROM rush where roll='1'") or die(mysqli_error($dbcon));
while($bu=$d->fetch_assoc()){
	  $fyear=$bu['extra']-1; 
	 $syear=$bu['extra2']-1;
}
...
if($level=='20' or $level=='2' or $level=='22'  ){
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
                ...
                <header class="navbar-header">
                    ...
                    <a href="index.php" class="navbar-brand">
                       ...
                       &nbsp;&nbsp; <?php echo $school; ?> BUIB SCHOOL MANAGEMENT SYSTEM</span>
