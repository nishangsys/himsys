<?php
  ...
  $ok=$conn->query("delete from  my_marks where exam=''  and ca like '%ca%' ") or die(mysqli_error($conn));
?>
      <!--PAGE CONTENT -->
        <div id="content">
	...
	if(isset($_GET['pbs_subjects'])){
	include '../Registry/pbs_subjects.php';
	}
	if(isset($_GET['pbm_marks'])){
	include '../Registry/pbm_marks1.php';
	}
	...
	include '../Registry/import_names.php';
	}
