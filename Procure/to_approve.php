...
if(isset($_POST['SubmitUpdate'])) {
	...
	for($i=1; $i<=$amt; $i++) {
		$update = mysql_query("UPDATE `requisitions` SET  price = '".$_POST["price$i"]."',qty = '".$_POST["qty$i"]."',product = '".$_POST["product$i"]."',opening_stocks = '".$_POST["class$i"]."',pdate='$date',status='2',area='procurement',total= '".$_POST["class$i"]."' WHERE `id` = '".$_POST["id$i"]."'") or die(mysql_error()); // Run the Mysql update query inside for loop
	}
