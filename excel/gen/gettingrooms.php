...
<h1 style="background:#333; color:#fff; padding:10px 0px">You're Are Giving Out a Room to <span style="color:#ff0"><?php  echo $name ?> at 
<span style="color:#0F0"><?php  echo $perdisc ?> frs Discount</span> </span>
            ...
            <tr><td></td><td><input type="hidden" name="block" value="<?php echo  $floor; ?>"   /></td></tr>          
                ...
                <tr><td>No of Days/Hours to Stay</td><td><select name="day" onBlur="doCalc(this.form)" required>
					...
					?>
                                  ...
                                  <tr><td> </td><td><input type="hidden" name="totdisc"    /></td></tr>

                
                                                     <tr><td> Discount</td><td><input type="text" name="disc" value="0" onBlur="doCalc(this.form)"    /></td></tr>
                ...
                <tr><td> </td><td><input type="hidden" name="ydisc" value="<?php echo $perdisc; ?>"   /></td></tr>
