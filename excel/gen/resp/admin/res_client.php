...
<body>
	...
	echo '<meta http-equiv="Refresh" content="0; url=adminpage.php?allreserves">';
		
		
	}
	
	?>
     <h1 style="background:#333; color:#FF0">Client Reservations Center</h1>
  
     <form method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>?reservations" enctype="multipart/form-data" >
    ...
    <table>
              ...
              <tr><td>Nationality</td><td><select name="pob">
...
<option value="Zimbabwe">Zimbabwe</option>
              ...
              <tr><td>Travelling To</td><td><input type="text" name="gemail" /></td></tr>
               ...
               <option>Female</option>
                ...
                <tr><td>NI No</td><td><input type="text" name="innum" /></td></tr>
                
              <tr><td>Place of Issue</td><td><input type="text" name="olevels" /></td></tr>
              
              
                <tr><td>Date of Issue</td><td><input type="text" name="alevels" /></td></tr>
                
                        
                  <tr><td></td><td><button type="submit" name="add" class="myButton"   >Make Resevations</button></td></tr>
            </table>
