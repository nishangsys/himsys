...
$query 	= mysql_query("SELECT * FROM `rooms` ORDER BY id ASC"); // Select from the table
...
if(isset($_POST['SubmitUpdate'])) {
	...
	$amt = $_POST['total']; // Get the total rows
	for($i=1; $i<=$amt; $i++) {
		$update = mysql_query("UPDATE `rooms` SET `num` = '".$_POST["room$i"]."', cateogry = '".$_POST["cateogry$i"]."', floor = '".$_POST["floor$i"]."'
		, disc = '".$_POST["disc$i"]."' WHERE `id` = '".$_POST["id$i"]."'"); // Run the Mysql update query inside for loop
	}
...
<div class="as_wrapper">
	<h1 class="h1"><a href="">Discount a Room</a></h1>
    <p>To discount rooms note the Following<br>
   <span style="color:#f00"> 1. Please percent sign (%) are allowed</span>
    </p
    >
    ...
    ?>
        ...
        <tr>
            ...
            <td style="background:#1188aa; padding:10px 10px">| <a class="a" href="?update" style="color:#fff">Discount Rooms</a></td>
        </tr>
        </table>
        <br />
        </form>
