...
<?php }?>
   ...
   <h1>Demographic statistics for the <?php echo $gtec; ?> <a href="adminpage.php?2" style="background:#1188aa; color:#ff0; padding:10px 10px">Finance Diagrams</a> <a href="adminpage.php?3" style="background:#000; color:#fff; padding:10px 10px">Visitors Diagrams </a></h1><br />
   <table>
