...
if(isset($_GET['grant'])){
	...
	$runm=mysql_query("SELECT * from staffs,staff_reg where staffs.id='$cust_id' and staffs.matric=staff_reg.matric GROUP BY staff_reg.matric ") or die (mysql_error());
...
$one=mysql_query("UPDATE staff_reg set permit='$totpermit'  where id='$id'   ") or die(mysql_error());
		...
		echo '<meta http-equiv="Refresh" content="1; url=../staffs/staffpage.php?permission">';
