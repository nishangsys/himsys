...
<div class="right">
    ...
    <?php
	$today=date('Y');
	$cust="SELECT * from customers where status='no' and gtec='$today' and level!=3 order by client_id  ";
    ...
    <td>
    <a href="assignroom.php?assigning=<?php echo $row['client_id'] ?>" target="_blank" style="color:#1188AA">Assign me a room!</a></td>
