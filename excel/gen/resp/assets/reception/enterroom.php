...
<h1 style="background:#333; color:#fff; padding:10px 0px"> <span style="color:#ff0"><?php  echo $name ?> Reserved a Room and Now he wants to Pay</span></h1>
...
<form method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>?enter=<?php echo $ids; ?>" enctype="multipart/form-data" >
    ...
    <table>         
          <tr><td></td><td><input type="hidden" name="id" value="<?php echo  $ids; ?>"   /></td></tr>
                 ...
                 <tr><td>Available Rooms </td><td> <input type="text" readonly name="sub_cat" value="<?php echo  $room; ?>" id="sub_cat"></td></tr>              
