...
@session_start();
   ...
   <?php
	...
	if(isset($_POST['send'])){
		...
		$p=mysql_query("INSERT INTO chat set name='$name', message='$mssg',yourid='$id',sentby='$se',sentto='$to'") or die(mysql_error());
		echo "<embed loop='false' src='../img/alarm.mp3' hidden='true' autoplay='true' ";
	}
