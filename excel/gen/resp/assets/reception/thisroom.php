...
<body>
   ...
   <div class="right" style="width:100%">
     ...
     <?php
	 $old=$_GET['id'];
	  $CHECK=mysql_query("SELECT * from  rooms,categories  where rooms.num='".$old."'
	  and categories.cat=rooms.cateogry") or die(mysql_error());
     ...
     2.<b>Room Floor</b>: <?php echo $a['floor']; ?></br>
