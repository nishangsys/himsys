...
<body>
	...
	?>
     <h1>Hourly Pay Clients: <?php if (isset($message)) { echo "<p class='message'>$message</p>";
}
?></h1>
  
     <form method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>?hourly" enctype="multipart/form-data" >
