...
<div class="right">
<h1 style="background:#00B1BA; color:#fff">Clients That have At least 10 frs before Taking a Room</h1>

    <?php
	
	$today=date('d-m-Y');
	$c=mysql_query("SELECT * from finances where date='$today' and finances.status!='2' and
    ...
    <td>
        <a href=javascript:popcontact('checkingout123.php?out=<?php echo $row['id'] ?>') style="color:#f00">Check me out!</a></td>
