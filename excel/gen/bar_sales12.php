...
?>
	...
	total='$total',qty='$qty',cp='$cp',status='$sta',tab='all',ids='all',section='Bar',closing_stocks='$stocks',area='15',profit='$profit',
...
*/
  ...
  <?php
	...
	total='$dbprice',qty='1',cp='0',status='$sta',tab='$table',ids='',section='".$serial."',opening_stocks='$avail',closing_stocks='$remproducts',area='".$a_area."',profit='$profit',time='$time',
