...
<h1>Please Click on Generate</h1>
<form method="post" action="?print_month">
	<table>
    	<tr>
        
         <td>Status </td><td><select name="status" style="width:170px" />
               
              <option value="2">Paid Staffs</option>
              <option value="0">Unpaid Staffs</option>
