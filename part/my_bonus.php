...
<div class="as_wrapper">
	<h1 class="h1" style="font-size:14px"> STAFF BONUSES</h1>
             ...
             <td style="text-align:center; word-break:break-all; width:10px;"> <?php echo $i++; ?></td>
								...
								<td style="text-align:center; width:350px;">
									 ...
									 <a href="<?PHP echo $_SERVER['_SELF']; ?>?adding_bonus=<?php echo $row ['id']; ?>"  data-toggle="modal"  class="btn btn-info" style="color:#fff" >Add Bonus </a>
								</td>
