...
$mat=$_GET['yourown'];
	...
	$year=$_GET['year'];;
	$d=mysql_query("SELECT * FROM payslips,voucher where payslips.month='$month' and voucher.month='$month' AND payslips.name=voucher.name and payslips.year='$year' and paid='2' GROUP BY payslips.name") or die(mysql_error());
