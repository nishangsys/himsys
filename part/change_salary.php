...
<div class="as_wrapper">
	<h1 class="h1" style="font-size:14px">CHANGE SALARY</h1>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from staffs WHERE matric!='' and banned='0' and dept!='POLICLINIC' order by name" ) or die (mysql_error());
								$i=1;
             ...
             <td style="text-align:center; word-break:break-all; width:10px;"> <?php echo $i++; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['salary']; ?></td>

								<td style="text-align:center; width:250px;">
									<a href="<?PHP echo $_SERVER['_SELF']; ?>?changing_salary=<?php echo $row['id']; ?>" class="btn btn-info" style="color:#fff">Change Salary </a>
