 ...
 ?>
    ...
    <table>
           ...
           <tr><td>Names</td><td><input type="text" name="name"   /></td></tr>
                ...
                <tr><td>Date of Birth</td><td><input type="text" name="tel"  style="width:300px" /></td></tr>
                   <tr><td>Place of Birth</td><td><input type="text" name="age"  style="width:300px" /></td></tr>
                     
            
               
                 <tr><td>Bank Account No</td><td><input type="text" name="address"  style="width:300px" /></td></tr> 
                 


 
                 <tr><td>Sex</td><td><select name="status"  style="width:300px" required  />
