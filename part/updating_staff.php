...
<div class="as_wrapper">
    ...
    <a class="btn btn-primary" href="<?PHP echo $_SERVER['_SELF']; ?>?register_staff"  style="text-decoration:none; color:#fff; padding:5px 10px">Click Here To Add </a>
             ...
             <td style="text-align:center; word-break:break-all; width:10px;"> <?php echo $i++; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:310px;"> <?php echo $row ['age']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['matric']; ?></td>
                  <td style="text-align:center; word-break:break-all; width:250px;"> <?php 
				  $C=mysql_query("SELECT * FROM staff_details WHERE yourid='".$row ['id']."' ") or die(mysql_error());
	if(mysql_num_rows($C)>0){
							echo "<span style='color:#00F'>Already added</span>";


	}
	else {
		echo "<span style='color:#f00'>Not Yet added</span>";
	}
				   ...
				   ?></td>
								...
								<td style="text-align:center; width:450px;">
									<a href="<?PHP echo $_SERVER['_SELF']; ?>?add_details=<?php echo $row ['id']; ?>" class="btn btn-info" style="color:#fff">Add Job Details</a>
									<a href="<?PHP echo $_SERVER['_SELF']; ?>?edit_details=<?php echo $row ['id']; ?>" class="btn btn-info" style="color:#fff">Edit</a>
								</td>
