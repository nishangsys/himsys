...
<?php if(isset($_POST['saves'])){		
	  ...
	  $paidto=$_SESSION['user_name'];
		...
		$daily=mysql_query("INSERT INTO daily set cust_id='members',room='$cat',total='$paid',reason='swimming pool',
			rec='$paid',date='$date',month='$month',year='$year',area='4',time='$mat',paidto='$paidto',idds='15'") or die(mysql_error());
