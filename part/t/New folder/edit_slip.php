                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
							 ...
							 $month=$month13;
								...
								$result= mysql_query("select * from staffs,payslips WHERE staffs.matric=payslips.matric order by payslips.name " ) or die (mysql_error());;
								$i=1;
             ...
             <td style="text-align:center; word-break:break-all; width:10px;"> <?php echo $i++; ?></td>
                            ...
                            <td style="text-align:center; word-break:break-all; width:130px; background:#9FC"> <?php echo $row ['salary']+$row['resp']+$row['research']+$row['rents']+$row['senior']+$row['leaves']+$row['trans']+$row['overtime']+$row['others']; ?></td>
								...
								<td style="text-align:center; width:350px;">
									<a href="?edit_b=<?php echo $row ['id']; ?>&month=<?php echo $row ['month']; ?>&thismonth=<?php echo $row ['thismonth']; ?>&year=<?php echo $row ['year']; ?>" class="btn btn-info" t style="color:#fff">edit bonus </a>
                               <a href="?edit_d=<?php echo $row ['id']; ?>&month=
									<?php echo $row ['month']; ?>&thismonth=<?php echo $row ['thismonth']; ?>&year=<?php echo $row ['year']; ?>" class="btn btn-danger" style="color:#fff"> edit deduction</a>
