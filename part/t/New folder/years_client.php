<html>
 ...
 <script language="JavaScript" src="../js/pop-up.js"></script>
   ...
   <th>For How Long</th>    
	...
	?>
                <td><?php echo $num++; ?>
					<td >Room <?php echo htmlspecialchars($room) ?></td>
					<td><?php echo htmlspecialchars($name) ?></td>
                    <td><?php echo htmlspecialchars($month) ?></td>
					<td><?php echo htmlspecialchars($date) ?></td>
                    <td><?php echo htmlspecialchars($howlong) ?> days</td>
					<td><?php echo htmlspecialchars($level) ?></td>
                        <td>    <a href=javascript:popcontact('../reception/yourinfo.php?roll=<?php echo htmlspecialchars($yourid) ?>') style="color:#1188AA">View </a></td>
