...
<div class="right">
  ...
  <div class="search_box" style="background:#9CF">
	...
	if(isset($_POST['search'])){
		...
		$se=mysql_query("SELECT * from customers where stu_name like '%".$name."%' and reg_date='$today' GROUP BY stu_name  order by stu_name ") or die(mysql_error());
		$i=1;
	}
	?>
   ...
   <td>S/N</td>
    ...
    <td>
    <a href="frontpage.php?old=<?php echo $row['client_id'] ?>"  style="color:#f00">Update my Info</a></td>
	...
	$cust="SELECT * from customers WHERE reg_date='$today'  order by stu_name  ";
