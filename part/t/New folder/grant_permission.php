...
<div class="right">
    ...
    <td><img src="../staffs/album/<?php echo  $row['photo'];?>" style="width:50px; height:50px"></td>
      
   <td>    <a href="adminpage.php?grant=<?php echo $row['id'] ?>"  style="color:#1188aa">GRANT PERMISSION!</a></td>
</td>
    </tr>
