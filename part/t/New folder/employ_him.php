...
<div class="right">
    ...
    <?php
	$today=date('Y');
	$cust="SELECT * from staffs where done!='2'  ";
    ...
    <td>
     <A href="../staffs/validatemem.php?roll=<?php echo $row['id']; ?>&dept=<?php echo $row['dept']; ?>">Employ</td>
    ...
    <?php
	 if(isset($_GET['id'])){
		 $ok=mysql_query("UPDATE staffs set done='2' where id='".$id."'") or die(mysql_error());
