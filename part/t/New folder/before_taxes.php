...
<div class="as_wrapper">
	<h1 class="h1"><a href="">Payment Voucher for <?php echo date('F Y'); ?> <span style="color:#f00">Before Taxes</span> </a></h1>
	...
	<div class="as_country_container">
            ...
            <tr>
                ...
                <input type="submit" name="SubmitUpdate" value="SAVE <?php echo date('F'); ?> Voucher" style="background:#1188aa; color:#fff; padding:10px 10px" /></td>
            </tr>
            </table>
            </form>
        <?php
