...
$ids=$_GET['add_details'] ;

	  $cure="SELECT * from staffs where id='" . $ids. "'  ";
...
<form method="post" action="" enctype="multipart/form-data" >
    ...
    <table>         
          <tr><td></td><td><input type="hidden" name="id" value="<?php echo  $ids; ?>"   /></td></tr>
              ...
              <option value="12">December</option>
               	...
               	<option value="<?php echo $floor; ?>"  onBlur="doCalc(this.form)"></option>
					...
					?>
                                ...
                                <tr><td> Function</td><td><input type="text" name="function"  value="<?php echo $rows['age']; ?>"    style="width:300px;"/></td></tr>  
                         <tr><td> Category</td><td><input type="text" name="cate" value="<?php echo $rows['cate']; ?>"     style="width:300px;"/></td></tr> 
                                 <tr><td> SVMC REG NO</td><td><input type="text" name="regno" value="<?php echo $rows['matric']; ?>"    style="width:300px;"/></td></tr>              
             ...
             <tr><td> ENSIF REG NO</td><td><input type="text" name="regno2"     style="width:300px;"/></td></tr> 
 ...
 if(isset($_POST['save'])){
	...
	$C=mysql_query("SELECT * FROM staff_details WHERE yourid='$yourid' ") or die(mysql_error());
	if(mysql_num_rows($C)>0){
							echo "<script>alert('ERROR.".$name." Has been registered already. Go and edit the details')</script>";
																	echo '<meta http-equiv="Refresh" content="0; url=staffpage.php?update_staff">';


	}
	else {
	$df=mysql_query("INSERT INTO staff_details set yourid='$yourid',name='$name',posItion='$position',
	dept='$dept',dob='$dob',doe='$doe',doi='$doi',cate='$cate',funct='$function',regno='$regno',regno2='$regno2'") or die(mysql_error());
