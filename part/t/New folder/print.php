...
body{
	font-size:16px;
	background:#fff url(../img/vg.png) no-repeat center;
...
if(isset($_GET['id'])){
    ...
    <div style=" float:left; width:800px; margin-top:-10px;TEXT-ALIGN:CENTER; background:#fff url(../img/vertical_logo%20(1).png) no-repeat center; border-bottom:1px solid#000;  height:50px; 
font-size:28px; ">
...
<div style=" float:left; width:20%; height:25px;font-size:17px; font-weight:bold; border:1px dashed#000; padding:10px 0px;"> Client's Names :</div>
...
<div style=" float:left; width:790px; background:#eee; margin:auto; height:25px;font-size:17px; border:1px dashed#000; padding:10px 0px;">

<div style=" float:left; width:20%; height:30px;font-size:17px; border-right:1px solid#000; font-weight:bold; padding:0px 0px;"> Room Chosen :</div>

<div style=" float:left; width:15%; height:30px;font-size:17px; border-right:1px solid#000; font-style:italic; padding:0px 0px;">Room <?php echo $row['room']; ?> :</div>

<div style=" float:left; width:15%; height:30px;font-size:17px; border-right:1px solid#000; font-weight:bold; padding:0px 0px;"> Checked In :</div>

<div style=" float:left; width:15%; height:30px;font-size:17px; border-right:1px solid#000; font-style:italic; padding:0px 0px;"> <?php echo $row['date']; ?> :</div>




<div style=" float:left; width:18%; height:30px;font-size:17px; border-right:1px solid#000; font-weight:bold; padding:0px 0px;"> Checked Out :</div>

<div style=" float:left; width:15%; height:30px;font-size:17px; border-right:1px solid#000; font-style:italic; padding:0px 0px;"> <?php echo $row['level']; ?> :</div>
...
<div style="background:#eee; height:auto; overflow:hidden; font-weight:bold; color:#333; width:98%">
...
<?php echo $days=($rows['howlong']) ?> Days</div>
 <div class="s"><?php echo $rows['date']; ?> <?php $owed=($rows['otherbal']); ?> </div>
