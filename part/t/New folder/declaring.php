...
<div class="right">
  ...
  ?>
<h1 > You are about to <span style="color:#F00"> DECLARE <?php echo $myname=$row['name']; ?> to CNPS</span> </span></h1> 
  ...
  <form method="post" action="<?PHP $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" >
    ...
    <table>
     ...
     <tr><td></td><td><button type="submit" name="update" class="myButton" style="color:#fff" >DECALRE TO CNPS</button></td></tr>
...
$_POST = array_map("ucwords", $_POST);
	...
	$ids=$_POST['id'];
	 ...
	 $image=mysql_query("UPDATE staffs SET cnps='2' where id='$matric' and id='$ids' ") or die(mysql_error());
	 

		
				echo "<script>alert('You have successfully declared staff to CNPS. Thank You')</script>";
