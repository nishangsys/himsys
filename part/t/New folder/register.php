...
if(empty($err)) {
 ...
 $sql_insert = "INSERT into `users`
		    ...
		    VALUES
		    ('$data[full_name]','$user_name@mysoftware.com','$sha1pass','$data[address]','$data[tel]','$data[fax]','$data[web]'
      ...
      <form action="<?php echo $_SERVER["PHP_SELF"] ?>?new_account" method="post" name="regForm" id="regForm" style="margin-top:-30px">
        <table width="100%" style="line-height:1.6" border="0" cellpadding="3" cellspacing="3" class="forms">
          ...
          <tr> 
            ...
            <td><input name="usr_email" type="text" id="usr_email3" value="admin12@yahoo.com" > 
             </td>
          </tr>
          
           <tr> 
           
            <tr><td>Level</td><td><select type="hidden" name="level" style="width:150px" />
                <option value="20">admin</option>
                
                <option value="5">Reception</option>
                <option value="10">Restaurant</option> 
                <option value="15">Bar/Snack</option> 
                <option value="101">Restaurant Chief</option> 
                <option value="150">Bar/Snack Chief</option>                
                <option value="100">Accountant</option>
