...
<div class="right">
 ...
 <td>   <a href="frontpage.php?changedate=<?php echo $row['client_id'] ?>" style="color:#f00" onclick="return confirm('Are you Sure you want to change <?php echo $row['stu_name']; ?> date')">Change now !</a></td>
</td>
    </tr>
