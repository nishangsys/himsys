...
<h1>SALARY VOUCHER FOR  20<?PHP $y=date('y')-1;  echo $y;?> - <?php
 ...
 <span style="float:right">Department: <?php echo $_GET['dept']; ?></span>
	...
	$month=$_GET['month'];
	$dept=$_GET['dept'];
	$cust="SELECT * from staffs,payslips where payslips.month='$month' and payslips.dept='$dept' and payslips.year='$today' and payslips.matric=staffs.matric and staffs.paytax!='1' GROUP BY staffs.matric";
