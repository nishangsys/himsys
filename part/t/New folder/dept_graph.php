...
<h1>Annual Expenditure on Salaries Stats per Department in <?php echo $year=date('Y'); ?></h1>                                    <canvas id="chartCanvas1" width="1100" height="900">
                            ...
                            <script type="application/javascript">
								...
								SUM(rents),SUM(senior),SUM(trans),SUM(leaves),SUM(research) from payslips WHERE year='$year' GROUP BY dept") or die(mysql_error());
                                ...
                                chart1.labels = [
                                <?php
                                $query = mysql_query("select * from payslips WHERE year='$year' GROUP BY dept") or die(mysql_error());
                                while ($row = mysql_fetch_array($query)) {
                                    ?>
                                    <?php echo "'" . $row['dept'] . "'" . ','; ?>	
                                <?php }; ?>
