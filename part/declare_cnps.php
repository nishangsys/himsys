...
<div class="as_wrapper">
	<h1 class="h1" style="font-size:14px">DECLARE OUR STAFF WITH CNPS| <a href="../staffs/printcnps.php" target="_blank" style="background:#1188aa; color:#fff; padding:10px 10px">Print Declared Staff</a></h1>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                                <tr>
                                 <th style="text-align:center;" >S/N</th>
                                    ...
                                    <th style="text-align:center;">CNPS Status</th>
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from staffs WHERE matric!='' AND dept!='POLICLINIC'  order by name" ) or die (mysql_error());
								$i=1;
             ...
             <td style="text-align:center; word-break:break-all; width:10px;"> <?php echo $i++; ?></td>
                            ...
                            <td style="text-align:center; word-break:break-all; width:250px;"> <?php $cnps=$row ['cnps'];
							$matric=$row['matric'];
							if($cnps!='2'){
								echo "<span style='color:#f00; font-weight:bold'>Not Declared</span>";
							}
							else {
																echo "<span style='color:#00f; font-weight:bold'> Declared</span>";
							 ...
							 ?></td>
                                ...
                                if($cnps!='2'){
								echo "
			<a href='staffpage.php?declare=$id' class='btn btn-info' style='color:#fff'>Declare</a>";

								;
							}
							else {
									echo "
			<a href='staffpage.php?undeclare=$id' class='btn btn-danger' style='color:#fff'>Undeclare</a>";
