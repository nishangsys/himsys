...
<div class="as_wrapper">
	<h1 class="h1" style="font-size:14px; background:#f00; color:#fff"> STAFF FINANCIAL DEDUCTIONS</h1>
             ...
             <td style="text-align:center; word-break:break-all; width:10px;"> <?php echo $i++; ?></td>
								...
								<td style="text-align:center; width:350px;">
									 ...
									 <a href="<?PHP echo $_SERVER['_SELF']; ?>?adding_sanctionf=<?php echo $row ['id']; ?>"  data-toggle="modal"  class="btn btn-danger" style="color:#fff" >Add Financial deduction </a>
								</td>
