...
<h1>SALARY VOUCHER FOR  20<?PHP $y=date('y')-1;  echo $y;?> - <?php
 ...
 <span style="float:right">Department: <?php echo $_GET['dept']; ?></span>
	...
	$month=$_GET['month'];
	$dept=$_GET['dept'];
	$cust="SELECT * from payslips where month='$month' and year='$today' order by dept,name ";
 ...
 else
 {
    ...
    <td style="text-align:left; padding:0px 10px;"><?php echo $row['name']; ?></td>
      <td style="text-align:left; padding:0px 10px;"><?php echo $row['matric']; ?></td>
      <td style="text-align:left; padding:0px 10px;"><?php echo $row['dept']; ?></td>
