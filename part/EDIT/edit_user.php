...
for($i=0;$i<$usersCount;$i++) {
	...
	$rt=mysql_query("UPDATE products set product='" . $_POST["product"][$i] . "', price='" . $_POST["price"][$i] . "',total='" . $toal[$i]. "',
...
<div style="width:950px; background:#1188aa; margin:auto">
...
$result = mysql_query("SELECT * FROM products WHERE pro_id='" . $_POST["users"][$i] . "'") or die(mysql_error());
$rt=1;
