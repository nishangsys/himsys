...
var p=$(_a31).combo("panel");
p.unbind(".combobox");
for(var _a33 in opts.panelEvents){
p.bind(_a33+".combobox",{target:_a31},opts.panelEvents[_a33]);
}
};
function _a34(e){
...
function _a36(e){
var _a37=$(this).panel("options").comboTarget;
if(!_a37){
return;
}
var opts=$(_a37).combobox("options");
var item=$(e.target).closest("div.combobox-item");
if(!item.length||item.hasClass("combobox-item-disabled")){
return;
}
var row=opts.finder.getRow(_a37,item);
if(!row){
return;
}
var _a38=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
_a13(_a37,_a38);
}else{
...
$(_a37).combobox("setValue",_a38).combobox("hidePanel");
}
e.stopPropagation();
};
function _a39(e){
var _a3a=$(this).panel("options").comboTarget;
if(!_a3a){
return;
}
var opts=$(_a3a).combobox("options");
if(opts.groupPosition=="sticky"){
var _a3b=$(this).children(".combobox-stick");
if(!_a3b.length){
_a3b=$("<div class=\"combobox-stick\"></div>").appendTo(this);
}
_a3b.hide();
$(this).children(".combobox-group:visible").each(function(){
var g=$(this);
var _a3c=opts.finder.getGroup(comboTarget,g);
var _a3d=state.data[_a3c.startIndex+_a3c.count-1];
var last=opts.finder.getEl(comboTarget,_a3d[opts.valueField]);
if(g.position().top<0&&last.position().top>0){
_a3b.show().html(g.html());
return false;
}
});
}
};
$.fn.combobox=function(_a3e,_a3f){
if(typeof _a3e=="string"){
var _a40=$.fn.combobox.methods[_a3e];
if(_a40){
...
_a3e=_a3e||{};
return this.each(function(){
var _a41=$.data(this,"combobox");
if(_a41){
$.extend(_a41.options,_a3e);
}else{
_a41=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_a3e),data:[]});
}
_a30(this);
if(_a41.options.data){
_a1d(this,_a41.options.data);
}else{
...
return $.extend($.data(jq[0],"combobox").options,{width:_a42.width,height:_a42.height,originalValue:_a42.originalValue,disabled:_a42.disabled,readonly:_a42.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
return jq.each(function(){
_a12(this,$.isArray(_a44)?_a44:[_a44]);
});
},clear:function(jq){
return jq.each(function(){
_a12(this,[]);
...
},select:function(jq,_a45){
return jq.each(function(){
_a0d(this,_a45);
});
},unselect:function(jq,_a46){
return jq.each(function(){
_a13(this,_a46);
});
},scrollTo:function(jq,_a47){
return jq.each(function(){
_a05(this,_a47);
});
}};
$.fn.combobox.parseOptions=function(_a48){
var t=$(_a48);
return $.extend({},$.fn.combo.parseOptions(_a48),$.parser.parseOptions(_a48,["valueField","textField","groupField","groupPosition","mode","method","url",{showItemIcon:"boolean",limitToList:"boolean"}]));
};
$.fn.combobox.parseData=function(_a49){
var data=[];
var opts=$(_a49).combobox("options");
$(_a49).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _a4a=$(this).attr("label");
...
row[opts.groupField]=_a4c;
}
data.push(row);
};
};
var _a4d=0;
var _a4e={render:function(_a4f,_a50,data){
var _a51=$.data(_a4f,"combobox");
var opts=_a51.options;
_a4d++;
_a51.itemIdPrefix="_easyui_combobox_i"+_a4d;
_a51.groupIdPrefix="_easyui_combobox_g"+_a4d;
_a51.groups=[];
var dd=[];
var _a52=undefined;
for(var i=0;i<data.length;i++){
...
if(_a52!=g){
_a52=g;
_a51.groups.push({value:g,startIndex:i,count:1});
dd.push("<div id=\""+(_a51.groupIdPrefix+"_"+(_a51.groups.length-1))+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_a4f,g):g);
dd.push("</div>");
}else{
_a51.groups[_a51.groups.length-1].count++;
}
}else{
_a52=undefined;
}
var cls="combobox-item"+(row.disabled?" combobox-item-disabled":"")+(g?" combobox-gitem":"");
dd.push("<div id=\""+(_a51.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
if(opts.showItemIcon&&row.iconCls){
dd.push("<span class=\"combobox-icon "+row.iconCls+"\"></span>");
}
dd.push(opts.formatter?opts.formatter.call(_a4f,row):s);
dd.push("</div>");
}
$(_a50).html(dd.join(""));
}};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupPosition:"static",groupField:null,groupFormatter:function(_a53){
return _a53;
},mode:"local",method:"post",url:null,data:null,queryParams:{},showItemIcon:false,limitToList:false,view:_a4e,keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
var _a54=e.data.target;
var opts=$(_a54).combobox("options");
if(opts.limitToList){
_a2c(_a54);
}
}}),panelEvents:{mouseover:_a34,mouseout:_a35,click:_a36,scroll:_a39},filter:function(q,row){
var opts=$(this).combobox("options");
...
var _a64=(p instanceof $)?p.attr("id").substr(_a63.itemIdPrefix.length+1):_a01(_a62,p);
