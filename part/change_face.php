                            ...
                            <thead>
                                <tr>
                                 <th style="text-align:center;" >S/N</th>
									...
									<th style="text-align:center;">Change Photo</th>
                                </tr>
                            </thead>
                            <tbody>
								<?php
								
								$result= mysql_query("select * from staffs WHERE matric!=''  and staffs.dept!='POLICLINIC' order by name" ) or die (mysql_error());
								$i=1;
             ...
             <td style="text-align:center; word-break:break-all; width:10px;"> <?php echo $i++; ?></td>
                            ...
                            <td style="text-align:center; word-break:break-all; width:250px;"> <?php echo $row ['tel']; ?></td>
								...
								<td style="text-align:center; width:250px;">
                                 <a href="?change_photo=<?php echo $row['id'] ?>" class="btn btn-info"   style="color:#fff">CHANGE!</a>
