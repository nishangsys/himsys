...
$_POST = array_map("ucwords", $_POST);
	 ...
	 */
	 ...
	 $image=mysql_query("INSERT INTO loans set  loan='$other_deducts',reason='$reasons',matric='$matric' ,name='$myname',month='$month',year='$year',dept='$dept',date='$date',types='financial' ") or die(mysql_error());
...
if($month==$month1 and $year==$year1){
	$delete=mysql_query("DELETE FROM loans where id='$id'") or die(mysql_error());
		...
		echo '<meta http-equiv="Refresh" content="0; url=deduct.php?adding_sanctionf='.$_GET['adding_sanctions'].'">';
