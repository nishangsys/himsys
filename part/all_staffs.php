...
<div class="as_wrapper">
    ...
    <a class="btn btn-primary" href="<?PHP echo $_SERVER['_SELF']; ?>?register_staff"  style="text-decoration:none; color:#fff; padding:5px 10px">Click Here To Add </a>
             ...
             <td style="text-align:center; word-break:break-all; width:10px;"> <?php echo $i++; ?></td>
                            ...
                            <td style="text-align:center; word-break:break-all; width:150px;"> <?php  echo $row['salary']; 
	
				?></td>

								<td style="text-align:center; width:350px;">
									<a href="<?PHP echo $_SERVER['_SELF']; ?>?edit" class="btn btn-info" style="color:#fff">Edit</a>
									 <a href="<?PHP echo $_SERVER['_SELF']; ?>?my_history=<?php echo $row ['id']; ?>"  data-toggle="modal"  class="btn btn-info" style="color:#fff" >Job Details </a>
								</td>
