...
$mat=$_GET['yourown'];
	...
	$year=$_GET['year'];;
	$d=mysql_query("SELECT * FROM payslips where payslips.month='$month' and payslips.year='$year' and payslips.name='$name'  and payslips.year='$year'") or die(mysql_error());
...
<!--others---->
 ...
 <div style="width:5%; height:20px; float:left; border:1px dashed#000; padding:2px 5px;text-align:center; font-weight:bold; ">7</div>
    ...
    <div style="width:46%; height:20px; float:left; text-align:LEFT; border:1px dashed#000; padding:2px 5px; ">Others 
    <?php
