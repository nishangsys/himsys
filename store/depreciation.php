...
<div class="as_wrapper">
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <td style="text-align:center; word-break:break-all; width:20px;"> <?php echo $num++; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:350px;"> <?php echo $row ['product']; ?></td>
								<td style="text-align:center; word-break:break-all; width:120px;"> <?php echo $row ['discribe']; ?></td>
								<td style="text-align:center; word-break:break-all; width:120px;"> <?php echo $row ['model']; ?></td>
								<td style="text-align:center; word-break:break-all; width:80px;"> <?php echo $row ['qty']; ?></td>
                       


								<td style="text-align:center; width:200px;">
				
									 <a href="delete.php?id=<?php echo $id;?>"  data-toggle="modal"  class="btn btn-danger" style="text-decoration:none; color:#fff; float:left; margin-left:5px" >Remove From Stock</a>
