...
<div class="as_wrapper">
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from dept_stocks where date='$today' order by item ASC" ) or die (mysql_error());
								$num=1;
                            ...
                            <td style="text-align:center; word-break:break-all; width:20px;"> <?php echo $num++; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:450px;"> <?php echo $row ['item']; ?></td>
                            ...
                            <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['sentto']; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:60px;"> <?php echo $row ['receive']; ?></td>
                               <td style="text-align:center; word-break:break-all; width:100px;"> <?php echo $row ['mark']; ?></td>
                               <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['senttby']; ?></td>
