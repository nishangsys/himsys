...
<div class="as_wrapper">
	<h1 class="h1" style="font-size:14px">Depleted Ware House  stocks | <a href="printfin.php" target="_blank"> Print a Copy</a></h1>
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from fixed_products where qty<1 order by product ASC" ) or die (mysql_error());
								$num=1;
