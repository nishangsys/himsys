...
<div class="as_wrapper">
	<h1 class="h1" style="font-size:14px">All Supply Activities to <span style="color:#f00"> <?php echo $sector; ?></span></h1>
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                             ...
                             <th style="text-align:center;">S/N</th>
                                    ...
                                    <th style="text-align:center;">Date Supplied</th>
...
<th style="text-align:center;">Receiver</th>
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from dept_stocks where sentto='$sector'  order by id DESC" ) or die (mysql_error());
								$num=1;
                            ...
                            <td style="text-align:center; word-break:break-all; width:20px;"> <?php echo $num++; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['item']; ?></td>
                            ...
                            <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['date']; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:100px;"> <?php echo $row ['receive']; ?></td>
