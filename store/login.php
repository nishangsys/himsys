...
{ 
			echo '<meta http-equiv="Refresh" content="0; url=admin/adminpage.php">';
...
{ 
			echo '<meta http-equiv="Refresh" content="0; url= stockpage.php">';
	 
}

else if ($status == 17) 
{ 
			echo '<meta http-equiv="Refresh" content="0; url= tental/rentalpage.php">';
