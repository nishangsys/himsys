...
<div class="as_wrapper">
    ...
    <a class="btn btn-primary" href="other_fixedstocks.php" target="_blank"  style="text-decoration:none; color:#fff; padding:5px 10px">Click Here To Add </a>
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <td style="text-align:center; word-break:break-all; width:20px;"> <?php echo $num++; ?></td>
								...
								<td style="text-align:center; word-break:break-all; width:100px;"> <?php echo $row ['qty']; ?></td>
                               <td style="text-align:center; word-break:break-all; width:100px;"> <?php echo $row ['date']; ?></td>


								<td style="text-align:center; width:320px;">
									<a href="edit_fixed.php<?php echo '?id='.$id; ?>" class="btn btn-info" style="text-decoration:none; color:#fff; float:left; margin-left:5px">Edit</a>
									 <a href="delete_fixed.php?id=<?php echo $id;?>"  data-toggle="modal"  class="btn btn-danger" style="text-decoration:none; color:#fff; float:left; margin-left:5px" >Delete </a>
