...
<div class="as_wrapper">
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from disburse where status='2' order by id ASC" ) or die (mysql_error());
								$num=1;
                            ...
                            <td style="text-align:center; word-break:break-all; width:20px;"> <?php echo $num++; ?></td>
								...
								<td style="text-align:center; width:200px;">
									<a href="edit.php<?php echo '?id='.$id; ?>" class="btn btn-info" style="text-decoration:none; color:#fff; float:left; margin-left:5px">Receive Returns</a>
