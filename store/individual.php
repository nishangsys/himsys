   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                             ...
                             <th style="text-align:center;">S/N</th>
                                    ...
                                    <th style="text-align:center;">Sentyby</th>
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from dept_stocks GROUP BY name,date order by id desc" ) or die (mysql_error());
								$num=1;
    ...
    <td style="text-align:center; word-break:break-all; width:200px;">
     ...
     <a href="A4.php?name=<?php echo $row ['name']; ?>&date=<?php echo $row ['date']; ?>&sentto=<?php echo $row ['sentto']; ?>" target="new">Print A 4</a> |  <a href="prec.php?name=<?php echo $row ['name']; ?>&date=<?php echo $row ['date']; ?>" target="new">Print B 4</a> </td>
