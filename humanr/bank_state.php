...
<body class="padTop53 " >
    ...
    <div id="wrap">
		...
		$reason=$_GET['reason'];
		 ...
		 $d=$con->query("SELECT SUM(amt),staffname,company,date,paidto,cust_id,discount FROM daily where company='$reason' and year='$ayear' and reason='fees' and company!='' GROUP BY id order by staffname") or die(mysqli_error($con));
$i=1;
?>
 <thead>
                                        <tr>
      ...
      <tr>
		...
		$reason=$_GET['reason'];
		 ...
		 $d=$con->query("SELECT SUM(amt),SUM(discount) FROM daily where company='$reason' and year='$ayear' and reason='fees' and company!='' GROUP BY company") or die(mysqli_error($con));
