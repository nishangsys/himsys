...
<form method="post" action="">
		...
		<input type="text" class="search_keyword" id="search_keyword_id" placeholder="Product Search" name="product" /><button name="search" style="padding:10px 10px; background:#0C0">Search</button>
