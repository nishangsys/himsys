...
$term=$semester;
	...
	move_uploaded_file($photo_temp,"../uploads/materials/$photo");	
	$dg=$con->query("SELECT * FROM materials where floc='$photo' ") or die(mysqli_error($con));
...
?>
 ...
 <h3>Uploading Materials for <?php echo $_GET['progg']; ?> LEVEL <?php echo $_GET['levels']; ?></h3>
  <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="email" placeholder="Program"  value="<?php echo $_GET['progg']; ?>" name="program" readonly="readonly">
      </div>
    </div>
   ...
   <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="email" placeholder=" Level" value="<?php echo $_GET['levels']; ?>" name="level" readonly="readonly">
      </div>
    </div>
...
?>                       
 ...
 else
 {
    echo '<tr bgcolor="White">';
       ...
       <td> 
         <a href="?levels=<?php echo $_GET['levels']; ?>&delete=<?php echo $bu['file_id']; ?>&progg=<?php echo $_GET['progg']; ?>&material"><button class="btn btn-danger" onclick="return confirm('Are you sure you want to delete <?php echo $bu['title']; ?>')"  >Delete</button></a>
	   ...
	   ?>
       | <a href="?levels=<?php echo $_GET['levels']; ?>&allows=<?php echo $bu['file_id']; ?>&progg=<?php echo $_GET['progg']; ?>&material"><button class="btn btn-warning" onclick="return confirm('Are you sure you want to publish <?php echo $bu['title']; ?>')"  >Publish </button></a>
       <?php } ?>
  ...
  if(isset($_GET['delete'])){
	  ...
	  echo '<meta http-equiv="Refresh" content="0; url= ?levels='.$_GET['levels'].'&progg='.$_GET['progg'].'&material= ">';
  }
