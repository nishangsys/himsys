		...
		?>
           <td><?php  echo $i++; ?></td>
                                            <td><?php echo $bu['prog_name']; ?></td>  
                                              ...
                                              <td><a href="?chose_prog&link=Admit Direct <?php echo $bu['prog_name']; ?> Entry&nam=<?php echo $bu['id']; ?>" style="font-weight:bold; color:#033">Admit <span style="color:#00F; font-weight:bold"><?php echo $bu['prog_name']; ?></span> </a></td>
