                    ...
                    <div class="span12">
                        ...
                        <div class="hero-unit-table">   
                            ...
                            <script type="application/javascript">
                                ...
                                chart1.data = [
                                <?php
                                $query = mysql_query("select SUM(exp) from daily WHERE purpose='expense' GROUP BY staffname") or die(mysql_error());
                                ...
                                chart1.labels = [
                                <?php
                                $query = mysql_query("select staffname from daily WHERE purpose='expense' GROUP BY staffname") or die(mysql_error());
                                while ($row = mysql_fetch_array($query)) {
                                    ?>
