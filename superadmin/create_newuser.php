...
if(empty($err)) {
 ...
 $sql_insert =$con->query( "INSERT into `users`
			...
			,now(),'$user_ip','2','$activ_code','$lev','$schoolx','$user_name'
			)
...
<h3>All Users</h3>
 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <?php
		 ...
		 $d=$con->query("SELECT * FROM users where banned!='20' ORDER BY id DESC") or die(mysqli_error($con));
$i=1;
?>
 <thead>
                                        <tr>
      ...
      <tr>
           ...
           <td><?php  echo $i++; ?></td>
             ...
             <td><?php  echo $bu['user_name']; ?></td>
              <td><a href="?create_newuser&del&id=<?php  echo $bu['id']; ?>"> <button  class="btn btn-danger" onClick="return confirm('Are you Sure About that')" >Remove from this Office</button></a></td>       
...
if(isset($_GET['del'])){
		 ...
		 echo '<meta http-equiv="Refresh" content="0; url=?create_newuser">';
}
